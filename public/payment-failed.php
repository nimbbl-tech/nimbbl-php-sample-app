...
if ($responseParam) {
    try {
        ...
        if ($parsedResponse) {
            ...
            $message = $payload['message'] ?? 'Payment failed. Please try again.';
        ...
        Logger::getInstance()->log("Payment failed page error: " . $e->getMessage(), SdkConstants::LOG_ERROR, SdkConstants::COMPONENT_REQUEST);
